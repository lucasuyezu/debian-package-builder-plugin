...
public class VersionHelper {
    ...
    /**
     * As {@link VersionHelper#VersionHelper(String[])} with elements got by
     * splitting string with given character.
     * 
     * @param version
    ...
    /**
     * Constructs new helper with given version elements. They are analyzed to
     * know which are responsible for the minor version and for the revision.
     * 
    ...
    /**
     * @return last revision imprinted in this version or <b>empty string</b> if
     *         no revision known
     */
    ...
    /**
     * @return last minor version imprinted in this version or <b>0</b> if no
     *         minor version known
     */
    ...
    /**
     * Replace the last numeric element. If there is no numeric element add the
