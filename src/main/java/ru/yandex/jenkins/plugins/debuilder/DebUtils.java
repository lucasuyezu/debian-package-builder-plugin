...
public class DebUtils {
    ...
    public static class Runner {
        ...
        /**
         * Same as {@link Runner#runCommand(String)} but with using a
         * {@link MessageFormat}
         * 
        ...
        /**
         * Execute the
         * {@link Shell#perform(AbstractBuild, Launcher, BuildListener)}
         * 
         * @param command
         *            The command
         * @param quiet
         *            Print or not print the command
         * @return Same as
         *         {@link Shell#perform(AbstractBuild, Launcher, BuildListener)}
         * @throws InterruptedException
         *             Same as
         *             {@link Shell#perform(AbstractBuild, Launcher, BuildListener)}
         */
        public boolean runCommandForResult(String command, Boolean quiet) throws InterruptedException {
            if (!quiet)
        ...
        /**
         * Same as {@link #runCommandForResult(String, Boolean)} printing the
         * command
         * 
         * @param command
         * @return Same as {@link #runCommandForResult(String, Boolean)}
         * @throws InterruptedException
         *             Same as {@link #runCommandForResult(String, Boolean)}
         */
        public boolean runCommandForResult(String command) throws InterruptedException {
            return runCommandForResult(command, false);
        }

        /**
         * Same as {@link Runner#runCommandForResult(String)} but with a
         * {@link MessageFormat}
         * 
         * @param commandTemplate
         *            The message template
         ...
         * @return Same as {@link Runner#runCommandForResult(String)}
         * @throws InterruptedException
         *             Same as {@link Runner#runCommandForResult(String)}
         */
        ...
        /**
         * Same as {@link Runner#runCommandForOutput(String)} but with a
         * {@link MessageFormat}
         * 
         * @param commandTemplate
        ...
        /**
         * Run the command inside a bash using
         * {@link ProcStarter#cmdAsSingleString(String)} and return the output
         * 
         * @param command
         *            The command
        ...
        /**
         * Same as {@link Runner#announce(String)} but with a
         * {@link MessageFormat}
         * 
